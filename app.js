...
// (document.location.host.indexOf('localhost') > -1 || document.location.host.indexOf('0.0.0.0') > -1 || document.location.protocol == 'file:');
>>>>>>> c0caa9f725371e031b52defb66f119e2e643447b
	...
	Path.map("#/").to(
		function(){
			...
			$.getJSON(API_URL + 'recent.json', function(res){
                ...
                var rendered_recents = render('plans', {plans: res, base_api_url: API_URL, notifier_url: NOTIFIER_URL, city_name: muni.display});
